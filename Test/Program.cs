...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var stream = new MemoryStream(File.ReadAllBytes(@"G:\WisganceResult.xlsx"));
            ...
            var file = new FileStream(@"G:\WisganceResult2.xlsx", FileMode.Create, System.IO.FileAccess.Write);
